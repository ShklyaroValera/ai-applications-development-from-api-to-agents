...
async def get_flow_diagram() -> bytes:
    ...
    # flow.png lives in the t9_mcp_fundamentals root folder (next to README.md)
    image_path = Path(__file__).parent.parent / "flow.png"
    if not image_path.exists():
        raise FileNotFoundError(f"flow.png not found at {image_path}")
