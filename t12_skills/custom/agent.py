    ...
    async def _chat_completion(self, messages: list[Message], log_messages: bool = False) -> Message:
        ...
        if choice.finish_reason == "tool_calls":
            ...
            if log_messages:
                ...
                print(json.dumps([m.to_dict() for m in tool_messages], indent=2, default=str))
        ...
        for tc in tool_calls:
            ...
            if tool is None:
                ...
                try:
                    ...
                    arguments = None
                    content = f"ERROR: invalid JSON arguments for '{tool_name}': {e}"
                if arguments is not None:
                    result_msg = await tool.execute(tc.id, arguments)
